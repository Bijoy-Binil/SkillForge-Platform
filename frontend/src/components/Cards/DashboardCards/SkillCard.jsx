...
const SkillCard = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#060b28f0] to-[#0a0e234d] backdrop-blur-sm rounded-xl shadow-lg p-6  border-0">
      {/* Header */}
        ...
        <table className="w-full">
          <thead>
            <tr className="text-gray-400 text-sm">
              ...
              <th className="text-right pb-3 hidden md:table-cell">BUDGET</th>
                ...
                <td className="py-4">
                  <div className="flex -space-x-2">
                    {project.members.map((member, i) => (
                      <img key={i} src={member.avatar} className="w-8 h-8 rounded-full border-2 border-gray-800" alt={member.name} />
                    ))}
                  </div>
                </td>
                <td className="text-right py-4 text-gray-300 hidden md:table-cell">{project.budget}</td>
